...
std::string getCmdLineParameterString(const int argc, char** argv, const char* string, const std::string defaultValue)
{
...
{
	int numbodies = 64*64;  // must be a power of 2!!
    ...
    parameters.modelPath = getCmdLineParameterString(argc, argv, "csvpath", "input.csv");
